...
<div className="col-lg-3 p-0" style={{width:"auto"}}><Link to={`/profiles/${item.author.name}`}>
     ...
     style = {{width: '70px', height: '70px'}}     
      />  </Link>  <div className="col-sm-9 side-avatar-username"><p className="mb-0 ms-0 mt-2 fw-bold text-start">{item.author.name}    <p className="mb-0 me-2 ms-0 mt-2 email-tag fw-light">     @{item.author.email}
