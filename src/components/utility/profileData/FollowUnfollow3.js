...
const FollowUnfollow3 = (currentProfile, followArrayValue) => {
...
const [followedProfiles2, setFollowedProfiles2] = useState(followArray) //from this we want to do the same fileter function immediately instead of awaiting exclusive fetch private state
...
const followArray = followArrayValue;
...
useEffect(() => {
   ...
   if( item.name == currentProfile.profile) {
...
export default FollowUnfollow3